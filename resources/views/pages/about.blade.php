                                            ...
                                            <div class="col-md-10 col-lg-10">
                                              <div class="card">
                                                 <div class="card-block">
                                                      ...
                                                      <table border="1" width="80%" >
                                                        ...
                                                        <tr>
                                                          <td width="60%" class="text2">
                                                            จังหวัดลำปางมีระบบสารสนเทศการตรวจประเมินและวางแผนปรับปรุงเพิ่มประสิทธิภาพฝาย<br>
                                                            พร้อมแนวทางและวิธีการแก้ไขปัญหา เพื่อเตรียมความพร้อมรับมือภัยแล้งและน้ำท่วม <br>
                                                            ในพื้นที่ทุกตำบลครอบคลุม 13 อำเภอในจังหวัดลำปาง 
                                                          </td>
                                                    ...
                                                    <br>
                                                    <center>
                                                      <h5>รูปภาพขอบเขตการดำเนินโครงการในพื้นที่ทั้งหมด 13 อำเภอของจังหวัดลำปาง</h5>
