                                          ...
                                          <!-- 1.4  ประตูระบายน้ำ / ระบายทราย-->
                                            <div class="border-checkbox-section" >
                                              <div class="form-group row">
                                                ...
                                                <div class="col-sm-2">
                                                  <div class="border-checkbox-group border-checkbox-group-primary">
                                                    <input class="border-checkbox" type="checkbox" id="gate_type_no" name="gate_has" value="2">
                                            ...
                                            <div class="border-checkbox-section" >
                                              <div class="form-group row">
                                                ...
                                                <div class="col-sm-2">
                                                  <div class="border-checkbox-group border-checkbox-group-primary">
                                                    <input class="border-checkbox" type="checkbox" id="gate_machanic_no" name="gate_machanic_has" value="2">
                                          ...
                                          <!-- 1.5  อาคารยังคับน้ำ-->
                                            <div class="border-checkbox-section" >
                                                <div class="form-group row">
                                                  ...
                                                  <div class="col-sm-2">
                                                    <div class="border-checkbox-group border-checkbox-group-primary">
                                                      <input class="border-checkbox" type="checkbox" id="water_building_no" name="control_building_has" value="2">
                                                    ...
                                                    <div class="form-group row">
                                                      ...
                                                      <div class="col-sm-10">
                                                        <div class="form-group row">
                                                          ...
                                                          <div class="col-sm-3">
                                                            <div class="border-checkbox-group border-checkbox-group-primary">
                                                              <input class="border-checkbox" type="checkbox" id="water_building_close_door_no" name="control_building_gate_has" value="2">
                                              ...
                                              <div class="form-group row" style="margin-top:-20px;">
                                                ...
                                                <div class="col-sm-7">
                                                  <div class="form-group row">
                                                    <div class="col-sm-3">
                                                      <div class="border-checkbox-group border-checkbox-group-primary">
                                                          <input class="border-checkbox" type="checkbox" id="water_building_open_machanic_yes" name="control_building_machanic_has"  value="1">
                                                          <label class="border-checkbox-label" for="water_building_open_machanic_yes">มี</label>
                                                      </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                      <div class="border-checkbox-group border-checkbox-group-primary">
                                                        <input class="border-checkbox" type="checkbox" id="water_building_open_machanic_no" name="control_building_machanic_has" value="2">
                                            ...
                                            <div class="border-checkbox-section" >
                                              <div class="form-group row" style="margin-top:-20px;">
                                                <label class="col-sm-2 col-form-label "> ระบบส่งน้ำ </label>
                                                  ...
                                                  <div class="col-sm-2">
                                                    <div class="border-checkbox-group border-checkbox-group-primary">
                                                      <input class="border-checkbox" type="checkbox" id="canal_no" name="canal_has"  value="2">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td rowspan="4" width="8%">
                                                                    <table class="table2 table-borderless" id="text2" style="vertical-align: top;"> 
                                                                        ...
                                                                        <tr >
                                                                            <td><div class="checkbox-color1 checkbox-primary"><input type="checkbox" id="3_3_2_normal_11_nosee" name="dgwall_3_remake[nosee]" value="1"><label for="3_3_2_normal_11_nosee"></label></div></td>
                                                                            <td>มองไม่เห็น</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td > อื่นๆ </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td rowspan="4" width="8%">
                                                                    <table class="table2 table-borderless" id="text2" style="vertical-align: top;"> 
                                                                        ...
                                                                        <tr >
                                                                            <td><div class="checkbox-color1 checkbox-primary"><input type="checkbox" id="3_3_3_normal_11_nosee" name="dggate_3_remake[nosee]" value="1"><label for="3_3_3_normal_11_nosee"></label></div></td>
                                                                            <td>มองไม่เห็น</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td > อื่นๆ </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td rowspan="4" width="8%">
                                                                    <table class="table2 table-borderless" id="text2" style="vertical-align: top;"> 
                                                                        ...
                                                                        <tr >
                                                                            <td><div class="checkbox-color1 checkbox-primary"><input type="checkbox" id="3_3_5_normal_11_nosee" name="dgblock_3_remake[nosee]" value="1"><label for="3_3_5_normal_11_nosee"></label></div></td>
                                                                            <td>มองไม่เห็น</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td > อื่นๆ </td>
                                                    ...
                                                    <!-- 6 -->
                                                        ...
                                                        <!-- 6.1 -->
                                                          ...
                                                          <tr>
                                                            <td>
                                                                <table class="table2 table-borderless" id="text2"> 
                                                                    <tr>
                                                                        <td><div class="checkbox-color1 checkbox-primary"><input type="checkbox" id="6_1_sed_n" name="check_floor_6" value="1"><label for="6_1_sed_n"></label></div></td>
                                                                        <td>ปกติ</td>
                                                                        <td><div class="checkbox-color1 checkbox-primary"><input type="checkbox" id="6_1_sed_l" name="check_floor_6" value="2"><label for="6_1_sed_l"></label></div></td>
                                                                        <td>น้อย</td>
                                                                    </tr>
                                                                </table>
                                                            </td> 
                                                          ...
                                                          <tr>
                                                            <td>
                                                                <table class="table2 table-borderless" id="text2"> 
                                                                    <tr>
                                                                        <td><div class="checkbox-color1 checkbox-primary"><input type="checkbox" id="6_1_sed_md" name="check_floor_6" value="3"><label for="6_1_sed_md"></label></div></td>
                                                                        <td>กลาง</td>
                                                                        <td><div class="checkbox-color1 checkbox-primary"><input type="checkbox" id="6_1_sed_m" name="check_floor_6" value="4"><label for="6_1_sed_m"></label></div></td>
                                                                        <td>มาก</td>
                                                                    </tr>
                                                                </table>
                                                            </td> 
                                                        ...
                                                        <!-- 6.2 -->
                                                          <tr>
                                                            ...
                                                            <td rowspan="4" width="8%" style="vertical-align: top;">
                                                                <textarea rows="7" cols="5" id="6_2_normal_9" name="6_side_damage" class="form-control" placeholder=""></textarea>
                                                            </td>
                                                            <td rowspan="4" width="8%">
                                                                <table class="table2 table-borderless" id="text2" style="vertical-align: top;"> 
                                                                    <tr>
                                                                        <td ><div class="checkbox-color1 checkbox-primary"><input type="checkbox" id="6_2_normal_11_no" name="side_6_remake[no]" value="1"><label for="6_2_normal_11_no"></label></div></td>
                                                                        <td>ไม่มี</td>
                                                                    </tr>
                                                                    <tr >
                                                                        <td><div class="checkbox-color1 checkbox-primary"><input type="checkbox" id="6_2_normal_11_nosee" name="side_6_remake[nosee]" value="1"><label for="6_2_normal_11_nosee"></label></div></td>
                                                                        <td>มองไม่เห็น</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td > อื่นๆ </td>
                                                                        <td><input id="weir_note_r62" name="side_6_remake[detail]" type="text" class=" form-control" placeholder=""> </td>
