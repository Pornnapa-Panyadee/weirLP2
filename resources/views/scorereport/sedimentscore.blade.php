...
<html lang="en">
  ...
  <body class="horizontal-icon-fixed" >
                        ...
                        <div class="col-md-12">
                          <div class="card table-card">
                            <div class="card-header">
                              <h3>แผนที่แสดงตำแหน่งฝายจำแนกตามปริมาณตะกอนหน้าฝาย ในพื้นที่จังหวัดลำปาง</h3>                              
                                ...
                                <div class="card-block">
                                  <div class="row">
                                    <div class="col-lg-9 col-xl-12">
                                      <div class="sub-title"> <h4> ตารางสรุปผลจำนวนฝายจำแนกตามปริมาณตะกอนหน้าฝาย ในพื้นที่จังหวัดลำปาง </h4> </div>
                                    </div> 
                                  </div>
                                  <div id="tableData">
    ...
    <script type="text/javascript">
      ...
      var amp=["ห้างฉัตร","เกาะคา","สบปราบ","เถิน","แจ้ห่ม","งาว","แม่เมาะ","แม่ทะ","เกาะคา","แม่พริก","เมืองปาน","เมืองลำปาง","วังเหนือ","เสริมงาม"];
