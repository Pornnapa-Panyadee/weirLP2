     ...
     <div class="pcoded-content">
        <table>
            <tr>
                ...
                <td width="70%">
                    ...
                    <div class="text2">โครงการพัฒนาระบบสารสนเทศการตรวจประเมินสภาพฝายและการบริหารจัดการพื้นที่เสี่ยงภัยแล้งและน้ำท่วมในจังหวัดลำปาง
                        <br>ในจังหวัดลำปาง
                         <br>โดย องค์การบริหารส่วนจังหวัดลำปาง ร่วมกับมหาวิทยาลัยเชียงใหม่ </div>
                </td>
        ...
        <?php 
            ...
            function check4($text,$r) {
                if($text==$r){
                    $img='https://watercenter.scmc.cmu.ac.th/weir/lampang/images/icon/check1.png';
            ...
            function checkCuase($text) {
                if($text!=NULL){
                    $img='https://watercenter.scmc.cmu.ac.th/weir/lampang/images/logo/check.png';
                    echo "<img src='{$img}'  width=15px;>";	
                    //echo  "<font size=\"4\"> &#9745;</font>";
                }else{
                    $img='https://watercenter.scmc.cmu.ac.th/weir/lampang/images/logo/square.png'; 
                     echo "<img src='{$img}'  width=15px;>";	
                }
            }
        ...
        <div class="text" >
          <table>
            <tr>
                ...
                <td class="line"><font class="outline">ตำแหน่ง </font> &nbsp;&nbsp; {{$code[9]}}{{$code[10]}} &nbsp;&nbsp;  </td>
          ...
          <table>
            <tr>
                <td width="20%" class="line"><font class="outline">ก่อสร้าง เมื่อปี พ.ศ.&nbsp;&nbsp;</font>&nbsp;&nbsp;{{ $weir[0]->weir_build}}&nbsp;</td>
                <td width="15%" class="line"><font class="outline"> อายุฝาย </font> &nbsp;&nbsp;{{ $weir[0]->weir_age}}&nbsp;&nbsp; </td>
                <td width="14%" >{{checkCuase($model->self->weir_self)}} &nbsp;&nbsp;ออกแบบเอง &nbsp;&nbsp;  </td>
                <td width="15%">{{checkCuase($model->self->weir_std)}} &nbsp;&nbsp;ใช้แบบมาตราฐาน &nbsp;&nbsp;  </td>  
                <td width="15%" class="line">&nbsp;&nbsp;{{$model->self->std_detial}}&nbsp;&nbsp; &nbsp;.</td>
            </tr>
          </table>
          <table>
            <tr>
                ...
                <td width="20%" class="line"> &nbsp;&nbsp;{{$model->self->villager_detial}} </td>
            </tr>
          </table>
        ...
        <div class="text">
            ...
            <div class="text4">1.4 ประตูระบายน้ำ/ระบายทราย &nbsp;&nbsp;&nbsp;{{checkHas($space[0]->gate_has)}}&nbsp;มี&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{checkZero($space[0]->gate_has)}} ไม่มี </div>   
                ...
                <table style="padding-left:70px;">
                    <tr>
                        ...
                        <td width=15%>{{checkHas($space[0]->gate_machanic_has)}}&nbsp;มี</td>
            ...
            <div class="text4">1.5 อาคารบังคับน้ำ &nbsp;&nbsp;&nbsp;{{checkHas($space[0]->control_building_has)}}&nbsp;มี&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{checkZero($space[0]->control_building_has)}} ไม่มี</div>  
                <table style="padding-left:70px;">
                    <tr>
                ...
                <table style="padding-left:70px;">
                    <tr>
                        ...
                        <td width=10% >{{checkHas($space[0]->control_building_gate_has)}}&nbsp;มี</td>
                ...
                <table style="padding-left:70px;">
                    <tr>
                        <td width=15% ></td>
                        <td width=15% >ชนิดเครื่องยกบาน</td>
                        <td width=10% >{{checkHas($space[0]->control_building_machanic_has)}} &nbsp;มี</td>
                        <td width=20% >{{checkZero($space[0]->control_building_machanic_has)}}&nbsp;ไม่มี</td>
            ...
            <div class="text4"> 
                <table>
                    <tr>
                        ...
                        <td width=15%>{{checkHas($space[0]->canal_has)}}&nbsp;มี</td>
                        <td>{{checkZero($space[0]->canal_has)}}&nbsp;ไม่มี</td>
                    </tr>
                </table>
                <table>
                    <tr>
