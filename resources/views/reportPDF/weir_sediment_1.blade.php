    ...
    <body>
        <div class="row" align="center" style="page-break-after:always; margin-top:60px;"> 
            <table align="center" class="customers" width="80%">
                <tr >
                    <td width="30%" class="customers"><img src="{{ asset('images/footer/lampang.png') }}" width="100px"></td>
                    <td width="30%" class="customers"><img src="{{ asset('images/footer/egat.jpg') }}" width="200px"></td>
                    <td width="30%" class="customers"><img src="{{ asset('images/footer/cmu.png') }}" width="100px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" height=200px; class="customers"> <font style="font-size:42px;"><b>{{$text_amp}}  จังหวัดลำปาง</b></td>
                </tr>
                <tr>
                ...
                <tbody>
                    ...
                    <?php }
                        ...
                        <tr>
                            ...
                            <td>{{$result[$i]['lat']}}</td>
                            <td>{{$result[$i]['long']}}</td>
                            <td>{{score($result[$i]['sediment_level'],2)}}</td>
                            <td>{{score($result[$i]['sediment_level'],3)}}</td>
                            <td>{{score($result[$i]['sediment_level'],4)}}</td>
