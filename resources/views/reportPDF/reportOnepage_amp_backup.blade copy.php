    ...
    <body>
        <div class="row" align="center" style=" margin-top:30px;"> 
            <table align="center" class="customers" width="80%">
                ...
                <tr>
                    <td colspan="3" height=500px; class="customers"> <font style="font-size:60px;"><b>{{$text_tm}} <br> {{$text_amp}} จังหวัดลำปาง</b></td>
                </tr>
                <tr>
        ...
        for($i=0;$i<$num;$i++){ ?>
            ...
            <table >
                <tr>
                    ...
                    <td>
                        <div class="text_head"> การตรวจสภาพฝายและแนวทางแก้ไขปรับปรุงเพื่อเพิ่มประสิทธิภาพฝาย ในพื้นที่ลุ่มน้ำแม่จาง จังหวัดลำปาง</div>
                    </td>
            ...
            <div class="text">
                    <table class="table5" border=1 style="margin-top:3px;">                   
                        ...
                        <tr>
                            <?php $url = "https://watercenter.scmc.cmu.ac.th/weir/lampang/images/map/".$result[$i]['location'][0]->weir_district."/".$result[$i]['weir'][0]['weir_code'].".jpg";
