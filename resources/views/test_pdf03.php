    ...
    <body>
     <div class="pcoded-content">
        <table>
            <tr>
                <td width="15%">
                    <img src="images/icon/egat.jpg" width="100%">
                </td>
                <td width="70%">
                ...
                <td width="15%">
                    <img src="images/icon/cmu.png" width="60%" >
                </td>
            </tr>
            <tr>
        ...
        <?php 
            ...
            function checkphoto($text){
                if($text!=NULL){
                    echo "<img src='https://watercenter.scmc.cmu.ac.th/weir/jang_basin/{$text}'  width=110px; style='margin:0 0 -10 10px;'>";
                }else{ echo "";}	
            }
        ...
        <div class="text">
            ...
            <div class="text4">1.5 อาคารบังคับน้ำ &nbsp;&nbsp;&nbsp;<?php checkHas($space[0]['control_building_has'])?>&nbsp;มี&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php checkZero($space[0]['control_building_has'])?> ไม่มี</div>  
                ...
                <table style="padding-left:70px;">
                    ...
                    <tr>
                        ...
                        <td width=10% ><?php checkpair($space[0]['control_building_gate_type'],"บานโค้ง")?> &nbsp;บานโค้ง</td>
            ...
            <div class="text4">1.6 พื้นที่รับประโยชน์ &nbsp;&nbsp;&nbsp;ประมาณ 
                <span class="line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $space[0]['benefit_area']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>ไร่ &nbsp;&nbsp;&nbsp;
                <?php checkHas($space[0]['comsumption'])?> &nbsp;&nbsp;อุปโภคบริโภค&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <?php checkHas($space[0]['agriculture'])?> &nbsp;&nbsp;การเกษตร&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        </div>
        <div class="text">
              ...
              <!-- 3 -->
                ...
                <!-- 3.3 -->
                    ...
                    <tr>
                        <td align="left">ตะกอน</td> 
                        <td>น้อย</td>
                        <td><?php check4($control[0]['dgfloor_erosion'],2)?></td>
                        <td><?php check4($control[0]['dgfloor_subsidence'],2)?></td>
                        <td><?php check4($control[0]['dgfloor_cracking'],2)?></td>
                        <td><?php check4($control[0]['dgfloor_obstruction'],2)?></td>
                        <td><?php check4($control[0]['dgfloor_hole'],2)?></td>
                        <td><?php check4($control[0]['dgfloor_leak'],2)?></td>
                        <td><?php check4($control[0]['dgfloor_movement'],2)?></td>
                        <td><?php check4($control[0]['dgfloor_drainage'],2)?></td>
                        <td><?php check4($control[0]['dgfloor_weed'],2)?></td>
                    </tr>
                    <tr>
                        <td>
                            <table > 
                        ...
                        <td>ปานกลาง</td>
                        <td><?php check4($control[0]['dgfloor_erosion'],3)?></td>
                        <td><?php check4($control[0]['dgfloor_subsidence'],3)?></td>
                        <td><?php check4($control[0]['dgfloor_cracking'],3)?></td>
                        <td><?php check4($control[0]['dgfloor_obstruction'],3)?></td>
                        <td><?php check4($control[0]['dgfloor_hole'],3)?></td>
                        <td><?php check4($control[0]['dgfloor_leak'],3)?></td>
                        <td><?php check4($control[0]['dgfloor_movement'],3)?></td>
                        <td><?php check4($control[0]['dgfloor_drainage'],3)?></td>
                        <td><?php check4($control[0]['dgfloor_weed'],3)?></td>
                    </tr>
                    <tr>
                        <td>
                            <table > 
                        ...
                        <td>มาก</td>
                        <td><?php check4($control[0]['dgfloor_erosion'],4)?></td>
                        <td><?php check4($control[0]['dgfloor_subsidence'],4)?></td>
                        <td><?php check4($control[0]['dgfloor_cracking'],4)?></td>
                        <td><?php check4($control[0]['dgfloor_obstruction'],4)?></td>
                        <td><?php check4($control[0]['dgfloor_hole'],4)?></td>
                        <td><?php check4($control[0]['dgfloor_leak'],4)?></td>
                        <td><?php check4($control[0]['dgfloor_movement'],4)?></td>
                        <td><?php check4($control[0]['dgfloor_drainage'],4)?></td>
                        <td><?php check4($control[0]['dgfloor_weed'],4)?></td>
                    </tr>
            </table>
            <div style="height:40px;"></div>
              ...
              <!-- 6 -->
               ...
               <!-- 6.3 -->
                <tr>
                    ...
                    <td><?php check4($waterdelivery[0]['gate_subsidence'],1)?></td>
