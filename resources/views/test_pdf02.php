    ...
    <body>
     <div class="pcoded-content">
        <table>
            <tr>
                <td width="15%">
                    <img src="images/icon/lp.png" width="80%">
                </td>
                <td width="70%">
                    <div class="text1"> แบบฟอร์มการตรวจสภาพฝาย</div>
                    <div class="text2">โครงการพัฒนาระบบสารสนเทศการตรวจประเมินสภาพฝายและการบริหารจัดการ
                        <br>พื้นที่เสี่ยงภัยแล้งและน้ำท่วมในจังหวัดลำปาง
                         <br>โดยองค์การบริหารส่วนจังหวัดลำปาง ร่วมกับมหาวิทยาลัยเชียงใหม่ </div>
                </td>
                <td width="15%">
